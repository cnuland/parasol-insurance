...
For this exercise make sure to use claim CLM202401 involving Marty McFly.
...
You can ask a follow up question to see more information that is being stored via RAG,
`Give me details on claim CLM202401`

[.bordershadow]
image::05/new-app-chat.png[]

Lastly, you can ask the assistant about about the information that was finetuned into the model during the RHEL AI portion of this workshop.
`How much does it cost to replace a flux capacitor on a DeLorean DMC-12 in millions of dollars.`
